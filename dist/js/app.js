...
(function () {
   CoreLibrary.Component = Stapes.subclass({
      ...
      /**
       * Same as htmlTemplate, but uses this value to as a path to fetch an HTML file
       * Do not use at the same time as htmlTemplate
       */
      htmlTemplateFile: null,

      constructor: function () {
         if (typeof htmlTemplate === 'string' && typeof htmlTemplateFile === 'string') {
         ...
         if (typeof this.htmlTemplateFile === 'string') {
            fetchHtmlPromise = CoreLibrary.getData(this.htmlTemplate)
               .then(function (html) {
         ...
         fetchHtmlPromise.then(function () {
            ...
            this.view = rivets.bind(element, this.scope);
...
CoreLibrary.ComponentPagination = Stapes.subclass({
   constructor: function ( component, htmlElement, scopeKey, array, startFrom ) {

Translations are handled by the `translationModule` which is part of the `widget-core-library`. The module fetches the corresponding translations from JSON files inside the `i18n` folder. 
